...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/gracer/Documents/bevbit_task/test.psyexp',
...
for thisTrial in trials:
    ...
    trialComponents = [key_resp_2, image]
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        frameRemains = 2.0 + 4.0- win.monitorFramePeriod * 0.75  # most of one frame period left
