...
#                   rinse
        ...
        files2make=['neu','sweet_match','sweet_PE','bitter_match','bitter_PE', 'AB', 'CD', 'EF']
        mydict={}
        try:
            for files in files2make:
                path='/Users/jennygilbert/Documents/niblunc/bevel_task/Output/onsets_withPE_fsl/%s_%s_%s.txt'%(sub,files,run)
            ...
            f_sweet_exp=open(mydict['sweet_match'], 'w')
            ...
            f_bitter_exp=open(mydict['bitter_match'], 'w')
