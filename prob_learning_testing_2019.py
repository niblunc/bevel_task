...
subdata['onset']='/Users/'+info['computer']+'/Documents/niblunc/bevel_task/efficiency/onset_'+info['run']
subdata['jitter']='/Users/'+info['computer']+'/Documents/niblunc/bevel_task/efficiency/jitter_'+info['run']
subdata['conds']='/Users/'+info['computer']+'/Documents/niblunc/bevel_task/efficiency/conds_'+info['run']
subdata['quit_key']='q'

#######################################
dataFileName='/Users/'+info['computer']+'/Documents/niblunc/bevel_task/Output/bevel_%s_%s_%s_subdata.log'%(info['participant'],info['run'],subdata['datestamp'])
...
subdata.update(info)
f=open('/Users/'+info['computer']+'/Documents/niblunc/bevel_task/Output/Bevel_subdata_%s.pkl'%datestamp,'wb')
pickle.dump(subdata,f)
f.close()

myfile = open('/Users/'+info['computer']+'/Documents/niblunc/bevel_task/Output/Bevel_subdata_%s.csv'%datestamp.format(**info), 'wb')
